...
// 	}
	...
	// @PostMapping("/view2")	//온습도 requestMapping + mothod post	//@RequestBody 자바 객체를 만들어준다.
	// public Model rcvArduinoTempHumi(@RequestBody TempHumiVO temHumVo, Model model) {	//아두이노에서 온 값을 @RequestBody는 자바객체로 만들어 vo담음
